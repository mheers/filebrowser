...
ace.define("ace/mode/demo_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/text_highlight_rules","ace/mode/html_highlight_rules"], function (require, exports, module) {
  "use strict";
  ...
  var DemoComponentHighlightRules = function () {
    HtmlHighlightRules.call(this);

    this.normalizeRules();
  };

  DemoComponentHighlightRules.metaData = {
    fileTypes: ["demo"],
    foldingStartMarker:
  ...
  oop.inherits(DemoComponentHighlightRules, TextHighlightRules);

  exports.DemoComponentHighlightRules = DemoComponentHighlightRules;
});

ace.define("ace/mode/demo",["require","exports","module","ace/lib/oop","ace/mode/html","ace/mode/demo_highlight_rules"], function (require, exports, module) {
  "use strict";

  var oop = require("../lib/oop");
  var HtmlMode = require("./html").Mode;

  var DemoComponentHighlightRules =
    require("./demo_highlight_rules").DemoComponentHighlightRules;

  var Mode = function () {
    HtmlMode.call(this);
    this.HighlightRules = DemoComponentHighlightRules;
  };
  oop.inherits(Mode, HtmlMode);

  (function () {
    this.$id = "ace/mode/demo";
    this.snippetFileId = "ace/snippets/demo";
  }.call(Mode.prototype));

  exports.Mode = Mode;
});                (function() {
                    ace.require(["ace/mode/demo"], function(m) {
