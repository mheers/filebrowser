...
ace.define("ace/mode/vue_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/text_highlight_rules","ace/mode/html_highlight_rules"], function (require, exports, module) {
  "use strict";
  ...
  var VueComponentHighlightRules = function () {
    ...
    this.$rules.start.push(
      ...
      {
        token: ["punctuation.definition.tag.html", "entity.name.tag.xml.html"],
        regex: /(<\?)(xml)/,
        push: [
          {
      ...
      },
      {
        ...
        regex:
          /(<)(script)\b(?![^>]*\/>)(?![^>]*type.?=.?text\/(?!javascript|babel|ecmascript).*)/,
        caseInsensitive: true,
        push: [
          {
            token: "punctuation.definition.tag.html",
      ...
      },
      {
        ...
        regex:
          /(<\/?)((?:address|blockquote|dd|div|dl|dt|fieldset|form|frame|frameset|h1|h2|h3|h4|h5|h6|iframe|noframes|object|ol|p|ul|applet|center|dir|hr|menu|pre)\b)/,
        caseInsensitive: true,
        push: [
          {
            token: "punctuation.definition.tag.end.html",
    ...
    this.$rules["#string-double-quoted"] = [
      {
    ...
    this.$rules["#string-single-quoted"] = [
      {
        token: "punctuation.definition.string.begin.html",
        regex: /'/,
        push: [
    ...
    this.$rules["#tag-generic-attribute"] = [
      {
...
ace.define("ace/mode/html_vue_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/html_highlight_rules","ace/mode/vue_highlight_rules"], function (require, exports, module) {
  "use strict";
  ...
  var HtmlVueHighlightRules = function () {
    HtmlHighlightRules.call(this);
    this.embedRules(VueHighlightRules);

    this.normalizeRules();
  };

  oop.inherits(HtmlVueHighlightRules, HtmlHighlightRules);

  exports.HtmlVueHighlightRules = HtmlVueHighlightRules;
});
...
ace.define("ace/mode/vue",["require","exports","module","ace/lib/oop","ace/mode/html","ace/mode/text","ace/mode/vue_highlight_rules"], function (require, exports, module) {
  "use strict";
  ...
  var VueComponentHighlightRules =
    require("./vue_highlight_rules").VueComponentHighlightRules;

  var Mode = function () {

    this.HighlightRules = VueComponentHighlightRules;
  };
  oop.inherits(Mode, TextMode);

  (function () {
    this.$id = "ace/mode/vue";
    this.snippetFileId = "ace/snippets/vue";
  }.call(Mode.prototype));

  exports.Mode = Mode;
});

ace.define("ace/mode/html_vue",["require","exports","module","ace/lib/oop","ace/mode/html_vue_highlight_rules","ace/mode/html","ace/mode/javascript","ace/mode/css","ace/mode/vue"], function (require, exports, module) {
  "use strict";

  var oop = require("../lib/oop");
  var HtmlVueHighlightRules =
    require("./html_vue_highlight_rules").HtmlVueHighlightRules;
  var HtmlMode = require("./html").Mode;
  var JavaScriptMode = require("./javascript").Mode;
  var CssMode = require("./css").Mode;
  var VueMode = require("./vue").Mode;

  var Mode = function () {
    HtmlMode.call(this);
    this.HighlightRules = HtmlVueHighlightRules;
    this.createModeDelegates({
      "html-": HtmlMode,
      "js-": JavaScriptMode,
      "css-": CssMode,
  ...
  (function () {
    this.$id = "ace/mode/html_vue";
  }.call(Mode.prototype));

  exports.Mode = Mode;
});                (function() {
                    ace.require(["ace/mode/html_vue"], function(m) {
